...
export const mockBusinesses: Business[] = [
  ...
  },
  {
    ...
    address: 'Modjo',
    city: 'Modjo',
    phone: '+251 111 11 11 11',
    email: 'info@unitedbeverages.et',
    bankAffiliation: 'Hibret Bank',
    bankId: 'hibret',
    logoUrl: 'https://images.unsplash.com/photo-1608270586620-248524c67de9?auto=format&fit=crop&q=80&w=200&h=200',
    coverUrl: 'https://images.unsplash.com/photo-1566633806327-68e152aaf26d?auto=format&fit=crop&q=80&w=1200&h=400',
  ...
  },
  {
    ...
    email: 'info@getas.com',
    bankAffiliation: 'Hibret Bank',
    bankId: 'hibret',
    logoUrl: 'https://images.unsplash.com/photo-1578916171728-46686eac8d58?auto=format&fit=crop&q=80&w=200&h=200',
    coverUrl: 'https://images.unsplash.com/photo-1604719312566-b76d4685332e?auto=format&fit=crop&q=80&w=1200&h=400',
    coordinates: { lat: 9.030, lng: 38.740 },
    gallery: [],
    products: [],
  ...
  },
  {
    ...
    name: 'Glorious PLC',
    category: 'Retail',
    description: 'Distributor of Sony electronics and home appliances.',
    address: 'Bole Road',
    city: 'Addis Ababa',
    phone: '+251 115 50 50 50',
    email: 'sales@glorious.com.et',
    bankAffiliation: 'Hibret Bank',
    bankId: 'hibret',
    logoUrl: 'https://images.unsplash.com/photo-1550009158-9ebf69173e03?auto=format&fit=crop&q=80&w=200&h=200',
    coverUrl: 'https://images.unsplash.com/photo-1550009158-9ebf69173e03?auto=format&fit=crop&q=80&w=1200&h=400',
    coordinates: { lat: 9.005, lng: 38.760 },
    gallery: [],
    products: [{ id: 'p43', name: 'Sony TV', description: '4K Smart TV.', price: 50000, imageUrl: '' }],
    services: [],
    rating: 4.5,
    reviews: 130,
    verified: true,
  ...
  },
  {
    ...
    bankAffiliation: 'Hibret Bank',
    bankId: 'hibret',
    logoUrl: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&q=80&w=200&h=200',
    coverUrl: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&q=80&w=1200&h=400',
    coordinates: { lat: 8.910, lng: 38.750 },
    gallery: [],
    products: [{ id: 'p44', name: 'Mattress', description: 'High density foam mattress.', price: 8000, imageUrl: '' }],
    services: [],
    rating: 4.1,
    reviews: 60,
    verified: true,
  ...
  },
  {
    ...
    category: 'Retail',
    description: 'Quality supermarket with a wide range of products.',
    address: 'CMC',
    city: 'Addis Ababa',
    phone: '+251 116 46 46 46',
    email: 'info@safeway.et',
    bankAffiliation: 'Hibret Bank',
    bankId: 'hibret',
    ...
    gallery: [],
    products: [],
    services: [{ id: 's45', name: 'Bakery', description: 'Fresh bread and pastries.', priceRange: 'Variable' }],
    rating: 4.2,
    reviews: 180,
    verified: true,
    features: ['Open Now', 'Pay with Tele Birr'],
  ...
  },
  {
    ...
    name: 'Nib Transport',
    category: 'Logistics',
    description: 'Reliable freight and passenger transport services.',
    address: 'Kality',
    city: 'Addis Ababa',
    ...
    gallery: [],
    products: [],
    services: [{ id: 's46', name: 'Freight', description: 'Heavy cargo transport.', priceRange: 'Quote based' }],
    rating: 4.0,
    reviews: 40,
    verified: true,
    features: ['Accepts Mobile Money'],
  ...
  },
  {
    ...
    category: 'Manufacturing',
    description: 'Leading paint and adhesive manufacturer.',
    address: 'Akaki',
    city: 'Addis Ababa',
    phone: '+251 114 34 08 88',
    email: 'info@kadisco.com',
    bankAffiliation: 'Nib International Bank',
    bankId: 'nib',
    logoUrl: 'https://images.unsplash.com/photo-1560185007-cde436f6a4d0?auto=format&fit=crop&q=80&w=200&h=200',
    coverUrl: 'https://images.unsplash.com/photo-1562259949-e8e7689d7828?auto=format&fit=crop&q=80&w=1200&h=400',
    coordinates: { lat: 8.880, lng: 38.770 },
    gallery: [],
    products: [{ id: 'p47', name: 'Kadisco Paint', description: 'Interior and exterior paint.', price: 0, imageUrl: '' }],
    services: [],
    rating: 4.3,
    reviews: 70,
    verified: true,
  ...
  },
  {
    ...
    category: 'Manufacturing',
    description: 'Producing steel sheets and profiles.',
    address: 'Adama',
    city: 'Adama',
    phone: '+251 221 11 11 11',
    ...
    coordinates: { lat: 8.540, lng: 39.270 },
    gallery: [],
    products: [{ id: 'p48', name: 'Corrugated Sheets', description: 'Roofing sheets.', price: 0, imageUrl: '' }],
    services: [],
    rating: 4.1,
    reviews: 35,
    verified: true,
  ...
  },
  {
    ...
    category: 'Construction',
    description: 'Developing residential and commercial properties.',
    address: 'Bole',
    city: 'Addis Ababa',
  ...
  },
  {
    ...
    name: 'Century Mall',
    category: 'Retail',
    description: 'One-stop shopping and entertainment destination.',
    address: 'Gurd Shola',
    city: 'Addis Ababa',
    phone: '+251 116 67 67 67',
    email: 'info@centurymall.et',
    bankAffiliation: 'Nib International Bank',
    bankId: 'nib',
    logoUrl: 'https://images.unsplash.com/photo-1519567241046-7f570eee3d9f?auto=format&fit=crop&q=80&w=200&h=200',
    coverUrl: 'https://images.unsplash.com/photo-1567449303078-57a63695666b?auto=format&fit=crop&q=80&w=1200&h=400',
    ...
    gallery: [],
    products: [],
    services: [{ id: 's50', name: 'Cinema', description: 'Multiplex cinema.', priceRange: '150-300 ETB' }],
    rating: 4.4,
    reviews: 300,
    verified: true,
    features: ['Open Now', 'Pay with Tele Birr'],
  ...
  },
  {
    ...
    category: 'Retail',
    description: 'Export of agricultural products and import of industrial goods.',
    address: 'Mexico',
    city: 'Addis Ababa',
    ...
    gallery: [],
    products: [],
    services: [{ id: 's51', name: 'Import/Export', description: 'International trade.', priceRange: 'Variable' }],
    rating: 4.1,
    reviews: 40,
    verified: true,
    features: ['Accepts Mobile Money'],
  ...
  },
  {
    ...
    category: 'Finance',
    description: 'Providing general and long-term insurance services.',
    address: 'Stadium',
    city: 'Addis Ababa',
